    ...
    const onSubmit = async (e) => {
        ...
        if (!isSigningIn) {
            ...
            try {
                ...
                // Success: No action needed because navigation is handled by userLoggedIn state
            } catch (error) {
            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    <div className="text-center">
                        <div className="mt-2">
                            <h3 className="text-gray-800 text-xl font-semibold sm:text-2xl">Hello, Lets Chat!</h3>
                        </div>
                    </div>
                    <form
                        onSubmit={onSubmit}
